...
export const FIREBASE_PRESETS: FirebasePreset[] = [
  {
    id: "banco-01",
    name: "Banco 01 (Turno Diurno 07h-14h15)",
    badge: "Diurno (07:00)",
    badgeColor: "bg-amber-500/15 text-amber-600 border-amber-500/30",
    description: "banco-01-34be4 (Banco Principal / Turno Diurno 07:00 às 14:15)",
    config: {
  ...
  {
    id: "banco-02",
    name: "Banco 02 (Turno Vespertino 14h15-20h)",
    badge: "Vespertino (14:15)",
    badgeColor: "bg-emerald-500/15 text-emerald-600 border-emerald-500/30",
    description: "banco-02-2fb6b (Banco Segundo / Turno Vespertino 14:15 às 20:00)",
    config: {
